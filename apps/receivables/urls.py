...
urlpatterns = [
    ...
    *[
    ...
    path(f"{_BASE}families/<uuid:family_id>/collection-accounts/legacy/", fam.FamilyLegacyAccountView.as_view()),
    ...
    *[
    ...
    path(f"{_BASE}statements/<uuid:statement_id>/void/", fam.StatementVoidView.as_view()),
    # fee schedules
